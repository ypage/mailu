<template>
  <div class="index-container login-container">
    <router-link :to="'/home'"><img src="../../assets/turn-back.png" class="turn-back"></router-link>
    ...
    <el-form autoComplete="on" :model="loginForm" :rules="loginRules" ref="loginForm" label-position="left" label-width="0px" class="card-box login-form">
      ...
      <!-- <div class='tips'>admin账号为:admin 密码12345</div> -->
      <!-- <div class='tips'>business账号:xiaolajiao 密码xlj123</div> -->
    </el-form>
