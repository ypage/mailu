...
<script>
    export default {
                ...
                default: (options) => {
                    return `
                        <div class="dz-preview dz-file-preview">
                            ...
                            <div class="dz-success-mark">${options.resMessage}</div>
        ...
        mounted () {
            ...
            // console.log(this)
            this.$el.innerHTML = `<div class="dz-default dz-message"><span><i class="el-icon-upload"></i><br>将文件拖到此处，或<a href="javascript:;">点击上传</a></span></div>`
            ...
            this.dropzone = new Dropzone(element, {
                ...
                params                      : this.getProp(this.params,this.dropzoneOptions.params),
